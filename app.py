...
class QAConfig:
    ...
    # كلمة سر المدير - يفضل وضعها في st.secrets أيضاً
...
class QAAnalyzer:
    ...
    def analyze_audio_final(self, file_path: str) -> Dict[str, Any]:
        ...
        {
          "Agent_Name": "<String>", "Call_Date": "<String>", "Patient_Name": "<String>", "DOB": "<String>",
          "Address": "<String>", "Phone_Number": "<String>", "Medicare_ID": "<String>",
          "Medical_History": { "Kidney_Disease": "YES/NO", "Cancer": "YES/NO", "Memory_Loss": "YES/NO", "Cognitive_Impairment": "YES/NO", "Caregiver": "YES/NO", "Medications": [], 
          ...
          "Objection_Handling": [{"Objection_Number": 1, "Category": "", "Patient_Reasoning": "", "Agent_Response": "", "Resolution": ""}],
          "Equipment_Details": {"Brace_Size": "", "Waist_Size": "", "Height": "", "Weight": ""},
          "Score": 0, "Call_Status": "Pass/Fail", "Detailed_Analysis": {"Strengths": [], "Weaknesses": [], "Narrative": ""} }
        """
...
class UIHandler:
    ...
    def render_usage_dashboard():
        st.markdown('<div class="card-title">💰 Daily API Consumption (Admin Only)</div>', unsafe_allow_html=True)
